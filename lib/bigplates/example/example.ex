defmodule Bigplates.Example do
  ...
  def create_variants() do
    ...
    variant_item_2 = %{
      name: "Virginia Honey Ham \u0026 Premium Roast Beef",
      price: 2.50,
      description: "I really like this"
    }

    variant_item_3 = %{
      name: "Ham, Genoa Salami and Pepperoni",
      price: 10,
      description: "Italian flavour"
    }
    ...
    variant_1 =
      Variant.new(%{name: "Standard Sub", type: :single, max_options: 1, required: true})
      |> Variant.add_multiple_variant_items([
        variant_item_1,
        variant_item_2,
        variant_item_3,
        variant_item_4,
    ...
    variant_2 =
      Variant.new(%{name: "Chips", type: :single, max_options: 2, required: false})
      |> Variant.add_multiple_variant_items([
        variant_item_1,
        variant_item_2,
        variant_item_3,
    ...
    variant_3 =
      Variant.new(%{name: "Cookie", type: :multiple, max_options: 2, required: false})
      |> Variant.add_multiple_variant_items([
        variant_item_1,
        variant_item_2,
        variant_item_3,
    ...
    variant_4 =
      Variant.new(%{name: "Drinks", type: :multiple, max_options: 1, required: true})
      |> Variant.add_multiple_variant_items([
        variant_item_1,
        variant_item_2,
        variant_item_3,
